...
export default function Button({title= '', className= ''}) {
  return (
    <button className={`${className}bg-neutral-100 transition-all duration-1000 hover:delay-75 hover:bg-neutral-950 group px-6 py-2 overflow-hidden relative rounded-full`}>
